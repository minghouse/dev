...
/**
 * @example
 * const res = await fetch('/google/getDatas2')
 * const data = await res.json()
 * console.log(data)
 */
const getDatas2 = async (req, res) => { 
    // 配置參數
    ...
    for (const v of sheetData_name) {
        ...
        sheetData_promise.push(common.accessGoogleSheets(SPREADSHEET_ID, `${v}!A${ai_start}:F${ai_end}`))
    }
